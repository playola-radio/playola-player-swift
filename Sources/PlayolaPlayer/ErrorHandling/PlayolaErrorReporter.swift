...
public final class PlayolaErrorReporter: @unchecked Sendable {
    ...
    // MARK: - Properties
    private static let logger = OSLog(subsystem: "fm.playola.PlayolaPlayer", category: "ErrorReporter")
...
public extension Error {
    ...
    ///   - function: Function name (automatically provided by default)
    ///   - level: The severity level of this error
    func playolaReport(file: String = #file,
                      line: Int = #line,
                      function: String = #function,
                      level: PlayolaErrorReportingLevel = .error) {
        Task { @MainActor in
            PlayolaErrorReporter.shared.reportError(self, file: file, line: line, function: function, level: level)
        }
    }
}
