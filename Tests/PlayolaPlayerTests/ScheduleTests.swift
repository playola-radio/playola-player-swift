...
struct ScheduleTests {
    ...
    -> [String: Spin]
  {
    let spin1 = Spin.mockWith(  // Far past spin - ended before now
      ...
      audioBlock: AudioBlock.mockWith(durationMS: 180_000, endOfMessageMS: 180_000),
      dateProvider: dateProvider
    )
    ...
    let spin2 = Spin.mockWith(  // Past spin - ended recently
      ...
      audioBlock: AudioBlock.mockWith(durationMS: 120_000, endOfMessageMS: 120_000),
      dateProvider: dateProvider
    )
    ...
    let spin4 = Spin.mockWith(  // Current - just started (overlaps with spin3)
      ...
      audioBlock: AudioBlock.mockWith(durationMS: 240_000, endOfMessageMS: 240_000),
      dateProvider: dateProvider
    )
  ...
  private func testCurrentOffsets(schedule: Schedule, now _: Date) {
