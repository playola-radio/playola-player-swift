...
struct ScheduleViewer: View {
  ...
  @State private var singleSpinPlayer: SingleSpinPlayer?
  ...
  private func playSingleSpin(_ spin: Spin) {
    Task {
      do {
        singleSpinPlayer = SingleSpinPlayer(spin: spin)
      } catch {
        print("Error playing single spin: \(error)")
        singleSpinPlayer = nil
      }
    }
  }
